<template>
	<div>
		...
		<div class="overview">
            ...
            <!-- 波纹ripple -->
			<div @click="play()" v-ripple="'rgba(000, 000, 255, 0.35)'" class="button is-primary">This is a button</div>
		...
		<img v-dummy="'400x200'" v-show="Outside" v-click-outside="onClickOutside" v-tooltip="{content: 'v-tooltip生成提示（类似title但是可以自定义位置pos）', color:'red', bgColor: 'red', pos: 'top'}"/>

        <!-- css生成的波纹效果 -->
		<div class="container text-center">
			<el-button type="danger" class="btn btn-default ripple btn-lg">Button with very long content</el-button>
            <!-- v-money生成前后缀 小数点 -->
